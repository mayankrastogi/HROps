...
<jsp:include page="../WEB-INF/header.jsp" flush="true">
	<jsp:param name="title" value="Manager - View Selected Applications" />
...
<%@page import="com.thebasilisks.Application"%><html>
  ...
  <div id="app_list">
  	<ul class="nav">
  	<%
  	ArrayList<Application> appList = Application.getApplications(employee.getDeptId(), Application.SELECTED);
...
<script type="text/javascript" src="../js/Manager/viewSelected.js"></script>
