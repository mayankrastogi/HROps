...
<jsp:include page="../WEB-INF/header.jsp" flush="true">
	<jsp:param name="title" value="Manager - View Rejected Applications" />
...
<%@page import="com.thebasilisks.Application"%><html>
  ...
  <div id="app_list">
  	<ul class="nav">
  	<%
  	ArrayList<Application> appList = Application.getApplications(employee.getDeptId(), Application.REJECTED_IN_SELECTION);
...
<!-- end .sidebar1 --></div>
  <div class="content">
  	<div id="rt_menubar">
  		<p>Reason for rejection: <span class="reason"></span></p>
  	</div>
  	<div id="rt_content">
...
<script type="text/javascript" src="../js/Manager/viewRejected.js"></script>
