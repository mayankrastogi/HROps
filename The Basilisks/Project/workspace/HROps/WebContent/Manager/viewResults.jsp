...
<jsp:include page="../WEB-INF/header.jsp" flush="true">
	<jsp:param name="title" value="Manager - View Interview Results" />
  ...
  <div class="content">
  	<div id="rt_menubar">
  		<ul>
  			...
  			<li id="select-button">Select Application</li>
...
<script type="text/javascript" src="../js/Manager/viewResults.js"></script>
