...
<jsp:include page="../WEB-INF/header.jsp" flush="true">
	<jsp:param name="title" value="HR - View Rejected Applications" />
...
<%@page import="com.thebasilisks.Application"%><html>
  ...
  <div id="app_list">
  	<ul class="nav">
  	<%
  	ArrayList<Application> appList = Application.getApplications(employee.getDeptId(), Application.REJECTED_IN_SHORTLISTING);
...
<script type="text/javascript" src="../js/HR/rejected.js"></script>
