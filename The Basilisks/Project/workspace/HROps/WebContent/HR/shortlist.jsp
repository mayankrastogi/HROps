...
<jsp:include page="../WEB-INF/header.jsp" flush="true">
	<jsp:param name="title" value="HR - View New Applications" />
...
<%@page import="com.thebasilisks.Application"%><html>
  ...
  <div id="app_list">
  	<ul class="nav">
  	<%
  	ArrayList<Application> appList = Application.getApplications(employee.getDeptId(), Application.UNREAD);
...
<!-- end .sidebar1 --></div>
  <div class="content">
  	<div id="rt_menubar">
  		<ul>
  			<li id="shortlist-button">Shortlist Application</li>
...
<script type="text/javascript" src="../js/HR/shortlist.js"></script>
